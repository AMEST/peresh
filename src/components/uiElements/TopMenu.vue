                ...
                <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu shadow" aria-labelledby="dropdownMenuButton">
                            <a v-if="$bgStyle=='bg-light'" @click="$bgStyle='bg-dark';uploadToDropBox()" class="dropdown-item" href="#">{{ $Lang.themeTumbler }} <font-awesome-icon icon="moon" /> </a><a v-else @click="$bgStyle='bg-light';uploadToDropBox()" class="dropdown-item" href="#">{{ $Lang.themeTumbler }} <font-awesome-icon icon="sun" /> </a>
